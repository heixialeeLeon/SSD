...
if __name__ == "__main__":
    ...
    #waiguanTestDataSet = VOCDetection(WAIGUAN_ROOT,image_sets='test', transform=BaseTransform(300, MEANS), target_transform=VOCAnnotationTransform())
    for item in vocDataset:
        img = item[0]
        print(item[1].shape)
        labels = list()
